...
function Skeleton() {
  return (
    <div className="min-h-screen animate-pulse">
      <div className="max-w-4xl mx-auto px-4 md:px-10 py-12 space-y-6">
        <div
        ...
        />
        <div
          className="h-14 rounded w-3/4"
          style={{ background: "rgba(255,255,255,0.08)" }}
        />
        <div
          className="h-4 rounded w-56"
    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-10 pb-20">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, transparent, rgba(59,43,238,0.3), transparent)",
          }}
        />
