        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6 items-center">
          ...
          <div className="flex flex-col gap-6 order-2 lg:order-1">
            <div className="flex flex-col gap-3">
              ...
              <h1 className="font-display text-3xl md:text-4xl lg:text-6xl font-bold leading-tight tracking-tight text-white">
                Hello, I&apos;m{" "}
                <span className="text-gradient">{fullName}</span>.
              </h1>

              <h2 className="text-slate-400 text-xl md:text-2xl font-light mt-2 font-display">
                {profile.headLine} | ASP.NET Core, Angular, SQL Server
              </h2>
          ...
          <div className="relative order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-80 max-w-sm aspect-[4/5]">
              {/* Blur decorations */}
              <div
              ...
              >
                <span className="text-amber-400 material-symbols-outlined text-[18px]">
                  star
                </span>
